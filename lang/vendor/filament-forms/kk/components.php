                    ...
                    'form' => [
                        ...
                        'preset' => [
                            ...
                            'options' => [
                                ...
                                'four' => 'Четыре',
                                'five' => 'Пять',
                                'two_start_third' => 'Два (Начать с третьей)',
                                'two_end_third' => 'Два (Закончить третьей)',
                                'two_start_fourth' => 'Два (Начать с четвертой)',
                                'two_end_fourth' => 'Два (Закончить четвертой)',
                            ],
                        ],
