...
class WorldMapBlock extends RichContentCustomBlock
{
    ...
    {
        return $action
            ->modalDescription('Configure the world map')
            ->schema([
