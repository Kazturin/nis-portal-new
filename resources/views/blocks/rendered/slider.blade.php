<div class="my-10">
        <div class="overflow-hidden page-slider">
                <div class="swiper-wrapper flex items-stretch mb-10">
                    ...
                    <div class="swiper-slide h-auto rounded-2xl overflow-hidden shadow-lg">
                        <img class="block w-full h-full object-cover" src="/storage/{{ $image['image'] }}" alt="slide">
                    </div>
                    @endforeach
                </div>
                <div class="flex justify-center space-x-2 max-w-fit mx-auto rounded-3xl bg-secondary p-2">
                  <div class="ad-swiper-button-prev p-1 bg-white rounded-full text-gray-700">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M15.7071 4.29289C16.0976 4.68342 16.0976 5.31658 15.7071 5.70711L9.41421 12L15.7071 18.2929C16.0976 18.6834 16.0976 19.3166 15.7071 19.7071C15.3166 20.0976 14.6834 20.0976 14.2929 19.7071L7.29289 12.7071C7.10536 12.5196 7 12.2652 7 12C7 11.7348 7.10536 11.4804 7.29289 11.2929L14.2929 4.29289C14.6834 3.90237 15.3166 3.90237 15.7071 4.29289Z" fill="#000000"/>
                  ...
                  <div class="ad-swiper-button-next p-1 bg-white rounded-full text-gray-700">
                  <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none">
