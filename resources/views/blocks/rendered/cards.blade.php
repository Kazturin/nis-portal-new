<div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
    ...
    <div 
        class="relative rounded-2xl overflow-hidden text-center"
        x-data="{ 
            visible: false, 
            count: 0, 
            formatted: '0', 
    ...
    >
    <img style="margin:0" class="w-full h-full" src="/img/card.png" alt="card">
        <div class="absolute inset-0 text-white px-6 py-5">
            ...
            <span 
                x-show="visible" 
                x-text="formatted"
                class="text-2xl md:text-3xl xl:text-4xl font-bold mr-4"
            ></span>
            @endif
