    ...
    <nav
        ...
        @foreach($tabs as $t)
            <button @click="tab = '{{ $t['id'] }}'"
                ...
                class="flex whitespace-nowrap items-center h-8 px-2 md:px-5 font-medium rounded-lg outline-none focus:ring-2 focus:ring-yellow-600 focus:ring-inset cursor-pointer"
