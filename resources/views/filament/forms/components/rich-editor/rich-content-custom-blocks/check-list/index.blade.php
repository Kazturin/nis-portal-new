        ...
        <ul class="mb-10">
            @foreach ($items as $item)
                <li class="flex items-center mb-6">
                    <span data-state="checked" class="bg-primary text-white rounded-full p-1.5 mr-4"
                        style="pointer-events: none;"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"
                            viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-check-icon size-3.5 stroke-[3]">
