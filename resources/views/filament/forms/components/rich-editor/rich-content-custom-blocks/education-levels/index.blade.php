<div class="not-prose mb-12 w-full hidden lg:block">
    <div class="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 overflow-x-auto pb-4">
        @foreach($items as $index => $item)
            ...
            @endphp
            <div
                class="flex flex-col items-center justify-end w-full group transition-transform duration-300 hover:-translate-y-2">
                {{-- Range and Unit --}}
